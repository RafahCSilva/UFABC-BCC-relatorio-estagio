...
Por intermédio dos cadastros de entradas e saídas, o Sistema deve calcular todo o Fluxo de Caixa ocorrido. Este é o módulo mais importante do financeiro, já que é nele que fica registrado todo o cruzamento dos dados cadastrados e a demonstração do fluxo do caixa por completo em um certo período.
...
O Sistema foi entregue em duas fases, a primeira foi no termino o Módulo Comercial e a segunda entrega foi na finalização o Módulo Financeiro. Conforme a necessidade de substituir o sistema contratado anteriormente, iniciando o seu uso pelo cadastro de todos os seus recursos e \textit{Jobs} feitos a partir no início do ano de 2017.
