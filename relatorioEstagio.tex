...
O Vue.js é um \textit{framework} JavaScript progressivo e incrementalmente adotável para construir componente dinâmicos em uma pagina HTML \cite{vue_complete_guide}~\cite{vuejs_oreilly}. Cumprindo um papel essencial para a criação do \textit{Iconr} no \textit{front-end} do Vulcano.
