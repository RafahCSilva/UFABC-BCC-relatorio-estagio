...
\subsection{A EQUIPE E OS PRODUTOS DA FTD}

O \textit{Vulcano} tem foco inicial em atender as necessidades do \textit{SAE}~\footnote{SAE, sigla para Serviço de Atendimento ao Editorial.} que apoia o Editorial com as confecções de outros insumos, como: ilustrações, mapas, infográficos, processamento de conteúdo, construção OEDs~\footnote{OED, sigla para Objetos Educacionais Digitais.}, e entre outros.
...
Desenvolvido em 2014, pelo extinto departamento de \textit{Novas Mídias}~\footnote{O departamento \textit{Novas Mídias} foi criado nos anos anteriores para atender as novas demandas de obras didáticas digitais do país.}, o \textit{Vulcano} possibilitou a automatização do controle do processo de criação de \textit{OEDs}, na qual seus desenvolvimento e controle eram manuais. 

O desenvolvimento de um OED inicia com sua concepção pelo Editorial, a fim de complementar um conteúdo por eles confeccionados. Todos os insumos necesarios sâo produzidos ou comprados, como: ilustrações, iconografias, mapas, áudios e locuções. Para ao final serem montadas ela equipe de desenvolvedores.

Dado a vasta gama de tipos diferentes de OED, 
