...
E somente o Administrador, Funcionário do Financeiro e do Planejamento por criar uma Proposta Comercial. Em seguida é disparado um e-mail para o Administrador e para o Funcionario do Financeiro avisando-os sobre um novo \textit{Job} que entrou na Etapa A.
...
Nesta etapa, somente tem permissão para editar o Administrador, Diretor, Funcionário do Financeiro e do Planejamento. E ao enviar esta proposta para a próxima etapa o Administrador e o Funcionário do Financeiro será avisado via e-mail.

\subsubsubsection{Etapa B - Orçamento e Condição de Pagamento}

Nesta etapa, o usuário poderá compor a Estimativa de Custo (ou orçamento) do \textit{Job} e cadastrar as condições de pagamento.
