...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{iconr_launch_index}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{iconr_gallery}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{iconr_formulario}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{iconr_carrossel}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{iconr_launch_checklist}
...
Na Etapa 4 o editor do editorial irá acessar a lista de iconográfica da obra, conforme pode ser vista na figura~\ref{fig:iconr:checklist}. Visualizar as imagens candidatas pelo \textit{Carrossel} da ferramenta, conforme a figura~\ref{fig:iconr:carrocel} e aprovará somente uma. A somatório do valor das aprovas será atualizada na listagem, conforme vemos também na figura~\ref{fig:iconr:checklist}.
