...
Após a conclusão da confecção do \textit{Job} e sua entrega, a Cadaris deve receber o pagamento pelo serviço realizado. Buscando um ótimo relacionamento com seus clientes, tem-se a necessidade do sistema ser flexível com os pagamentos conforme as necessidades do cliente. 
...
Deste modo o sistema gerencia as contas a receber no fluxo do caixa

\noindent 
- Faturamento de Jobs (Parcelas)
