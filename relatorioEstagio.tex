...
Decisões técnicas também são debatidas e o time, em comum acordo, arquitetou que a ferramenta será integrada no \textit{front-end} utilizando a biblioteca \textit{VueJS}, enquanto o \textit{back-end} implementará toda a troca de informações via API REST.

A segunda parte da reunião é a \textit{planning}, na qual o time organiza as histórias em tarefas e planejam a sequencia que estas tarefas serão realizadas. E será melhor relatada na seção seguinte.
